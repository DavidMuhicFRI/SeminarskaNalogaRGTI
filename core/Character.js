    ...
    switch(name) {
      ...
      case 'Curve':
        this.stats = {
          ...
          abilityText: '(THE FORCE) can curve his throw by pressing "space" and dragging the mouse',
      ...
      case 'Tripp':
        this.stats = {
          ...
          minusPassive: 'Is a lightweight at drinking',
          abilityText: '(SOUL SWAP) Switches his de-buffs and health with the enemy\'s',
